...
interface JourneymateAPI {
    companion object {
        val instance: JourneymateAPI = Retrofit.Builder().baseUrl("https://e037-177-240-169-205.ngrok-free.app/api/v1/").addConverterFactory(GsonConverterFactory.create()).client(
